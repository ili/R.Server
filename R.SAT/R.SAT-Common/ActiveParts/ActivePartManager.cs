...
namespace Rsdn.SmartApp
{
	...
	{
		private readonly Dictionary<Type, IActivePart> _parts =
			new Dictionary<Type, IActivePart>();
...
#pragma warning restore 0649
		...
		/// </summary>
		public object GetPartInstance([NotNull] Type type)
		{
			if (type == null)
			...
			IActivePart part;
			if (!_parts.TryGetValue(type, out part))
		...
		public void Activate()
		{
			...
			try
			{
				...
				{
					IActivePart part;
					if (!_parts.TryGetValue(info.Type, out part))
					{
						part = (IActivePart)info.Type.CreateInstance(ServiceProvider);
						_parts.Add(info.Type, part);
					}
					part.Activate();
				}
			}
